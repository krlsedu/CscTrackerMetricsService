...
env.VERSION_NAME = "";
env.SERVICE_NAME = "csctracker_services_metrics"
env.IMAGE_NAME = "csctracker-metrics-service"
env.REPOSITORY_NAME = "CscTrackerMetricsService"
                    ...
                    script {
                        withCredentials([string(credentialsId: 'csctracker_token', variable: 'token_csctracker')]) {
                            httpRequest acceptType: 'APPLICATION_JSON',
                                    ...
                                    requestBody: '''{
                                                       "app" : "Jenkins",
                                                       "text" : "The remote service ''' + env.SERVICE_NAME + ''' has been successfully updated to version: ''' + env.VERSION_NAME + '''"
                                                    }''',
                                    customHeaders: [[name: 'authorization', value: 'Bearer ' + env.token_csctracker]],
                                    url: 'https://gtw.csctracker.com/notify-sync/message'
                        }
